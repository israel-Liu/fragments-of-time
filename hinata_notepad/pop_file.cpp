...
BOOL PopFileRead(HWND hwnd_edit, PTSTR pstrFileName)
{
    BYTE bySwap;
    DWORD dwBytesRead;
    HANDLE hFile;
    ...
    if (INVALID_HANDLE_VALUE == (hFile = CreateFile(pstrFileName, GENERIC_READ,
    ...
    SetWindowText(hwnd_edit, (PTSTR)pConv);
...
BOOL PopFileWrite(HWND hwnd_edit, PTSTR pstrFileName)
{
    ...
    iLength = GetWindowTextLength(hwnd_edit);
    ...
    GetWindowText(hwnd_edit, pstrBuffer, iLength + 1);
